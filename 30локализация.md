отформатируй текст: ГЛАВА 30  Локализация 30.1. Теория Локализация частично уже рассматривалась в главе 27 "Дата и время" и в главе 28 "Форматирование и парсинг". 
